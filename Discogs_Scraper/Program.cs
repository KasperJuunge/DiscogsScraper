...
namespace Discogs_Scraper
{
    class Program
    {
        ...
        {
            // INIT
            string startUrl = @"https://www.discogs.com/search/?sort=have%2Cdesc&format_exact=LP&format_exact=Vinyl&format_exact=Album&genre_exact=Hip+Hop&limit=250&page=1";
            string genre = "HipHop";
            int numData = 1000;
            ...
            Console.WriteLine("Url to be scraped:" + Scraper.startUrl);
            Console.WriteLine("");
